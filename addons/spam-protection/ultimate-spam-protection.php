			...
			'fields' => array(
				'uacf7_spam_protection_heading' => array(
					...
					'content' => sprintf(
						...
						'<a href="https://themefic.com/docs/uacf7/free-addons/spam-protection-for-contact-form-7/" target="_blank">See Demo</a>',
				...
				'uacf7_minimum_time_limit' => array(
					...
					'subtitle' => __('You can avoid spamming bots by setting a time limit to prevent too frequent submissions. Put in seconds', 'ultimate-addons-cf7'),

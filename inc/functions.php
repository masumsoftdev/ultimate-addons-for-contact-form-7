...
function uacf7_multistep_pro_features_demo( $all_steps, $form_id ) {
	...
	<div class="multistep_fields_row" style="display: flex; flex-direction: column;">
		...
		foreach ( $all_steps as $step ) {
			?>
			<h3><strong>Step
					<?php echo $step_count; ?> <a style="color:red" target="_blank"
						href="https://cf7addons.com/preview/pro">(Pro)</a>
				</strong></h3>
			<?php
			if ( $step_count == 1 ) {
				?>
	...
	<div class="control-box">
		<fieldset>
			<legend>
				...
				<a href="https://cf7addons.com/preview/repeater-field/" target="_blank">Check Preview</a>
			</legend>
			<table class="form-table">
				<tbody>
					...
					<tr>
						<th scope="row"><label for="tag-generator-panel-text-values">
								<?php echo __( 'Add Button Text', 'ultimate-addons-cf7' ) ?>
							</label></th>
						<td><input type="text" name="" class="tg-name oneline uarepeater-add" value="Add more"
								id="tag-generator-panel-uarepeater-nae"></td>
					</tr>
					<tr>
						<th scope="row"><label for="tag-generator-panel-text-values-remove">
								<?php echo __( 'Remove Button Text', 'ultimate-addons-cf7' ) ?>
							</label></th>
						<td><input type="text" name="" class="tg-name oneline uarepeater-remove" value="Remove"
								id="tag-generator-panel-uarepeater-n"></td>
					</tr>
			...
			<div class="notice notice-info themefic_review_notice">
				...
				<ul>
					...
					<li><a target="_blank"
							...
							<?php _e( 'I need help', 'ultimate-addons-cf7' ) ?>
						</a></li>
					<li><a href="#" class="never" data-status="never"><span class="dashicons dashicons-dismiss"></span>
							<?php _e( 'Never show again', 'ultimate-addons-cf7' ) ?>
						</a></li>
				</ul>
				<button type="button" class="notice-dismiss review_notice_dismiss"><span class="screen-reader-text">
						<?php _e( 'Dismiss this notice.', 'ultimate-addons-cf7' ) ?>
					</span></button>
			</div>

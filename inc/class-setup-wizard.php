					...
					<div class="uacf7-single-step-content installation <?php if ( $uacf7_plugin_status != 'activate' ) {
						...
						<div class="uacf7-single-step-content-wrap">
							...
							<div class="uacf7-single-step-content-inner">
								...
								<p><?php echo _e( "The easiest and best Contact Form 7 Addons Plugin for WordPress. Packed with 28+ essential features, this All-in-One Contact form 7 addon plugin consists almost all the basic to advanced options that you may need for your WordPress site’s Contact form.", 'ultimate-addons-cf7' ) ?>
								</p>
